...
export const zhTW: Messages = {
  ...
  promo: {
    ...
    brand: {
      lead: "專注幫你",
      rest: "讀懂網頁",
      subtitle: "頁內搜尋、劃詞翻譯、AI 總結，用哪個裝哪個。\n網頁內容只在你電腦上處理，不會上傳。",
    },
    popup: {
      lead: "讀懂網頁",
      rest: "也更好用",
      subtitle: "集成文字搜尋、內容總結、劃詞翻譯等實用工具，按需安裝，打造你的網頁工作臺。",
    },
    privacy: {
      lead: "記錄僅存",
      rest: "本機",
      subtitle: "網頁內容與使用痕跡留在你的瀏覽器裡，KnowIt 不上傳、不代存。",
    },
    privacyLocal: "使用記錄僅存本機",
    privacySync: "設定與訂閱可以跟隨Chrome同步",
    privacyKey: "模型 Key 自備自管",
    setup: {
      lead: "一鍵安裝",
      rest: "馬上使用",
      subtitle: "打開 Chrome 應用商店，點一下就能裝上。",
    },
    workbenchTitle: "工作臺",
    localTitle: "本地處理",
    localPageContent: "網頁內容",
    localFindHistory: "查找記錄",
    localGenerations: "生成結果",
    storeName: "KnowIt",
    addToChrome: "新增至 Chrome",
    storeRating: "5.0 ★（7 則評分）",
    storeShare: "分享",
    storeType: "擴充功能",
    storeCategory: "效率工具",
    stats: {
      lead: "使用頻率",
      rest: "一眼就知",
      subtitle: "天數、次數和用量打開就能看到。\n資料只留在這台電腦上。",
      panelTitle: "使用統計",
      panelHint: "最近讀得勤不勤、用了多少、調用是否順利，都在這裡。",
      days: {
        label: "使用天數",
        value: "6",
        unit: "天",
        caption: "首日激活 2026-09-10",
      },
      uses: {
        label: "累計使用",
        value: "77",
    ...
    previewHint: "頁面隨窗口適配，建議在 1280×800 下截圖。可用 ?lang=zh-TW&theme=dark 鎖定語言和主題。",
  },
  appsTitle: "工具清單",
  appsSubtitle: "安裝擴展後，在工作臺按需啟用這些工具。",
  paidTag: "付費",
  freeTag: "免費",
  detailsTitle: "工具詳情",
  detailsClose: "關閉",
  ...
  appPhilosophy: {
    ...
    "ad-cleaner": {
      sections: [
        {
          paragraphs: [
            "瀏覽網頁時，廣告幾乎無處不在。彈窗、側邊欄、懸浮層……它們不僅打斷注意力，甚至讓人分不清哪些是內容，哪些是推廣。市面上的廣告過濾工具很多，有的收費，有的技術很強。作為一個個人開發的起步階段工具，在廣告識別的精準度上，它暫時還比不上那些成熟的付費產品。",
        ...
        },
        {
          title: "二、一次授權，長久省心",
          paragraphs: [
            "考慮到部分網站的廣告結構較為複雜，工具需要讀取和解析頁面元素才能實現精準過濾。首次安裝時，我會請求必要的權限——這不是過度索取，而是為了後續所有網頁都能自動完成過濾。",
      ...
      sections: [
        {
          paragraphs: [
            ...
            "這個工具就是為解決這個小麻煩做的。它的想法很簡單：不搞複雜的東西，只做好一件事。",
          ],
        },
        {
          title: "一、把複雜的開發者工具，變成一個順手的小工具",
          paragraphs: [
            "瀏覽器自帶的檢查功能很強，但它是給開發人員準備的，面板裡堆滿了網絡請求、報錯信息、源碼調試這些普通人用不上的東西。這個工具把這些全砍掉了，只保留最常用的幾個功能：吸取顏色、查看字體大小、量一下間距、看看圓角是多少。界面乾乾淨淨，打開就能用，鼠標挪到哪兒就顯示哪兒的信息，不用學，也不用記快捷鍵。",
          ],
        },
        {
    ...
    "smart-writer": {
      sections: [
        ...
        },
        {
          title: "三、想解決什麼問題？",
          paragraphs: [
            "既然瀏覽器才是現在大多數人真正碼字的地方，那為什麼不能把好用的文字輔助功能帶到網頁上來呢？這個工具做的就是這件事——把「AI 幫改文字」的能力從辦公軟件裡解放出來，讓它出現在每次需要打字的地方。尤其是遇到正式場合、重要表達的時候，能有一個冷靜的助手在旁邊幫忙把關措辭和語法，心裡會踏實很多。",
          ],
        },
        {
          title: "四、具體怎麼用？",
  ...
  privacyPolicy: {
    ...
    intro:
      "歡迎使用 KnowIt。KnowIt 是一款以本地優先為設計原則的瀏覽器擴展，專注提升網頁閱讀效率。本隱私協議旨在說明我如何處理與你使用產品相關的信息，以及這些信息在本地、瀏覽器同步與第三方服務之間的邊界。",
    sections: [
      {
        title: "第1條 定義",
        items: [
          {
            id: "1.1",
            text: "「KnowIt」指本瀏覽器擴展及其可按需安裝的各類工具，包括但不限於頁內文字查找、內容總結、劃詞翻譯、頁面導出等功能。",
          },
          {
            id: "1.2",
      ...
      },
      {
        ...
        items: [
          {
            id: "2.1",
            text: "本地優先：網頁內容、選中文字、頁內查找記錄、總結文本、生成結果等，默認僅在本地處理，不上傳至 KnowIt 自有服務器。",
          },
          {
            id: "2.2",
          ...
          {
            id: "2.3",
            text: "配置同步：工具安裝狀態、偏好設置等，可能通過瀏覽器自帶的同步能力，跟隨你已登錄的 Google 賬號在不同設備間同步。該同步由瀏覽器服務提供，KnowIt 不運營獨立的雲端賬號系統。",
          },
          {
            id: "2.4",
          ...
          {
            id: "2.5",
            text: "新標籤頁聯網搜索：若你在新標籤頁使用搜索框，查詢將通過瀏覽器 Chrome Search API 提交，由你設置的默認搜索引擎處理；KnowIt 不會替換、修改或記錄你的搜索提供商設置與查詢內容。",
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        items: [
          {
            id: "1.1",
            text: "KnowIt 提供瀏覽器擴展形態的網頁閱讀效率工具，支持按需安裝其中的工具，幫助你完成頁內查找、總結、翻譯、導出等工作。新標籤頁中的聯網搜索由瀏覽器默認搜索引擎處理，KnowIt 不提供或替換默認搜索服務。",
          },
          {
            id: "1.2",
  ...
  changelogEntries: [
    ...
    },
    {
      ...
      items: [
        "網頁輸入框裡也能直接翻譯",
        "翻譯會按原文自動判斷要譯成哪種語言",
        "翻譯、劃詞識字、總結遇到明顯不能處理的內容時，會給出相應提示，並優化了這類內容的處理方式",
        "同一時間只保留一個工具懸浮層，面板不會疊在一起",
        "AI 寫作懸浮窗和其他工具對齊了樣式",
        "全局小圖標換成同一套",
        "新標籤頁加了官網入口",
      ],
    },
    {
      ...
      items: [
        ...
        "重新設計歷史記錄頁面",
        "重新設計新 tab 頁",
        "新標籤頁搜索改用瀏覽器默認搜索引擎（Chrome Search API），不再內置搜索引擎切換",
        "劃詞翻譯支持放大查看",
        "新增免費工具「元素檢查器」：檢查頁面元素並吸取顏色",
        "新增免費工具「廣告清除」：自動隱藏網頁廣告與推廣浮層，支持撤銷",
        "修復未啟用工具時樣式仍影響原網頁、資源下載器無法打開的問題",
      ],
    },
    {
      version: "2.3.0",
