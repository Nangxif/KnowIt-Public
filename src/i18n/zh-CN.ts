...
export const zhCN: Messages = {
  ...
  highlightMarketplaceTitle: "模块化工具",
  ...
  promo: {
    ...
    brand: {
      lead: "专注帮你",
      rest: "读懂网页",
      subtitle: "页内搜索、划词翻译、AI 总结，用哪个装哪个。\n网页内容只在你电脑上处理，不会上传。",
    },
    popup: {
      lead: "读懂网页",
      rest: "也更好用",
      subtitle: "集成文字搜索、内容总结、划词翻译等实用工具，按需安装，打造你的网页工作台。",
    },
    privacy: {
      lead: "记录仅存",
      rest: "本机",
    ...
    setup: {
      lead: "一键安装",
      rest: "马上使用",
      subtitle: "打开 Chrome 应用商店，点一下就能装上。",
    },
    workbenchTitle: "工作台",
    localTitle: "本地处理",
    localPageContent: "网页内容",
    localFindHistory: "查找记录",
    localGenerations: "生成结果",
    storeName: "KnowIt",
    addToChrome: "添加至 Chrome",
    storeRating: "5.0 ★ (7 个评分)",
    storeShare: "分享",
    storeType: "扩展程序",
    storeCategory: "效率工具",
    stats: {
      lead: "使用频率",
      rest: "一眼就知",
      subtitle: "天数、次数和用量打开就能看到。\n数据只留在这台电脑上。",
      panelTitle: "使用统计",
      panelHint: "最近读得勤不勤、用了多少、调用是否顺利，都在这里。",
      days: {
        label: "使用天数",
        value: "6",
        unit: "天",
    ...
    previewHint: "页面随窗口适配，建议在 1280×800 下截图。可用 ?lang=zh-CN&theme=dark 锁定语言和主题。",
  },
  appsTitle: "工具清单",
  appsSubtitle: "安装扩展后，在工作台按需启用这些工具。",
  paidTag: "付费",
  freeTag: "免费",
  detailsTitle: "工具详情",
  detailsClose: "关闭",
  ...
  creatorNoteParagraphs: [
    ...
    "这一问题已在 KnowIt 3.0.0 中修复。若你尚未更新，升级到新版本后便不会再遇到这种情况。",
  ...
  appPhilosophy: {
    ...
    "ad-cleaner": {
      sections: [
        {
          paragraphs: [
            "浏览网页时，广告几乎无处不在。弹窗、侧边栏、悬浮层……它们不仅打断注意力，甚至让人分不清哪些是内容，哪些是推广。市面上的广告过滤工具很多，有的收费，有的技术很强。作为一个个人开发的起步阶段工具，在广告识别的精准度上，它暂时还比不上那些成熟的付费产品。",
        ...
        },
        {
          title: "二、一次授权，长久省心",
          paragraphs: [
            "考虑到部分网站的广告结构较为复杂，工具需要读取和解析页面元素才能实现精准过滤。首次安装时，我会请求必要的权限——这不是过度索取，而是为了后续所有网页都能自动完成过滤。",
      ...
      sections: [
        {
          paragraphs: [
            ...
            "这个工具就是为解决这个小麻烦做的。它的想法很简单：不搞复杂的东西，只做好一件事。",
          ],
        },
        {
          title: "一、把复杂的开发者工具，变成一个顺手的小工具",
          paragraphs: [
            "浏览器自带的检查功能很强，但它是给开发人员准备的，面板里堆满了网络请求、报错信息、源码调试这些普通人用不上的东西。这个工具把这些全砍掉了，只保留最常用的几个功能：吸取颜色、查看字体大小、量一下间距、看看圆角是多少。界面干干净净，打开就能用，鼠标挪到哪儿就显示哪儿的信息，不用学，也不用记快捷键。",
          ],
        },
        {
    ...
    "smart-writer": {
      sections: [
        ...
        },
        {
          title: "三、想解决什么问题？",
          paragraphs: [
            "既然浏览器才是现在大多数人真正码字的地方，那为什么不能把好用的文字辅助功能带到网页上来呢？这个工具做的就是这件事——把「AI 帮改文字」的能力从办公软件里解放出来，让它出现在每次需要打字的地方。尤其是遇到正式场合、重要表达的时候，能有一个冷静的助手在旁边帮忙把关措辞和语法，心里会踏实很多。",
          ],
        },
        {
          title: "四、具体怎么用？",
    ...
    sections: [
      {
        ...
        items: [
          {
            id: "1.1",
            text: "「KnowIt」指本浏览器扩展及其可按需安装的各类工具，包括但不限于页内文字查找、内容总结、划词翻译、页面导出等功能。",
          },
          {
            id: "1.2",
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: "2.3",
            text: "配置同步：工具安装状态、偏好设置等，可能通过浏览器自带的同步能力，跟随你已登录的 Google 账号在不同设备间同步。该同步由浏览器服务提供，KnowIt 不运营独立的云端账号系统。",
          },
          {
            id: "2.4",
    ...
    sections: [
      {
        ...
        items: [
          {
            id: "1.1",
            text: "KnowIt 提供浏览器扩展形态的网页阅读效率工具，支持按需安装其中的工具，帮助你完成页内查找、总结、翻译、导出等工作。新标签页中的联网搜索由浏览器默认搜索引擎处理，KnowIt 不提供或替换默认搜索服务。",
          },
          {
            id: "1.2",
  ...
  changelogEntries: [
    {
      ...
      items: [
        "网页输入框里也能直接翻译",
        "翻译会按原文自动判断要译成哪种语言",
        "翻译、划词识字、总结遇到明显不能处理的内容时，会给出相应提示，并优化了这类内容的处理方式",
        "同一时间只保留一个工具悬浮层，面板不会叠在一起",
        "AI 写作悬浮窗和其他工具对齐了样式",
        "全局小图标换成同一套",
        "新标签页加了官网入口",
      ],
    },
    {
      ...
      items: [
        ...
        "划词翻译支持放大查看",
        "新增免费工具「元素检查器」：检查页面元素并吸取颜色",
        "新增免费工具「广告清除」：自动隐藏网页广告与推广浮层，支持撤销",
        "修复未启用工具时样式仍影响原网页、资源下载器无法打开的问题",
      ],
    },
    {
      version: "2.3.0",
