...
export const enUS: Messages = {
  ...
  promo: {
    ...
    brand: {
      ...
      rest: "page better",
      subtitle:
        "In-page find, selection translation, and AI summaries—install only what you use.\nPage content is processed on your computer and never uploaded.",
    },
    popup: {
      lead: "Read pages",
      rest: "work better",
      subtitle: "Find, summarize, and translate in the page. Install only the tools you need.",
    },
    privacy: {
      lead: "History",
      rest: "on-device",
    ...
    setup: {
      ...
      rest: "start using it",
      subtitle: "Open the Chrome Web Store and install KnowIt in a single click.",
    },
    workbenchTitle: "Workbench",
    localTitle: "Local processing",
    localPageContent: "Page content",
    localFindHistory: "Find history",
    localGenerations: "Generation results",
    storeName: "KnowIt",
    addToChrome: "Add to Chrome",
    storeRating: "5.0 ★ (7 ratings)",
    storeShare: "Share",
    storeType: "Extension",
    ...
    stats: {
      lead: "Usage",
      rest: "at a glance",
      subtitle: "See days, opens, and usage as soon as you look.\nThe numbers stay on this computer.",
      panelTitle: "Usage stats",
      panelHint: "How often you read, how much you use, and whether calls succeed.",
      days: {
        label: "Days used",
        value: "6",
        unit: "days",
        caption: "First opened 2026-09-10",
      },
      uses: {
        label: "Total uses",
        value: "77",
    ...
    previewHint:
      "Pages adapt to the window; capture at 1280×800. Use ?lang=en-US&theme=dark to lock language and theme.",
  },
  appsTitle: "Tools",
